...
curl -F file=@$WORKSPACE/ClusterService-Vulnerability-report.xlsx -F "initial_comment=DSSC report for Cluster service image" -F channels=buildnotification -H "Authorization: Bearer xoxp-375765158032-376600608661-770335782017-e9c151417f7793292b3310cc9653f851" https://slack.com/api/files.upload
'''
...
curl -F file=@LocationService-Vulnerability-report.xlsx -F channels=buildnotification -H "Authorization: Bearer xoxp-375765158032-376600608661-770335782017-e9c151417f7793292b3310cc9653f851" https://slack.com/api/files.upload'''
          }
        }
