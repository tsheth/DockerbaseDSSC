...
curl -F file=@$WORKSPACE/ClusterService-Vulnerability-report.xlsx -F "initial_comment=DSSC report for Cluster service image" -F channels=buildnotification -H "Authorization: Bearer xoxp-375765158032-376600608661-770344733697-116fe6bd7b3f779cc170a0c8f39ff344" https://slack.com/api/files.upload
'''
...
curl -F file=@$WORKSPACE/LocationService-Vulnerability-report.xlsx -F channels=buildnotification -H "Authorization: Bearer xoxp-375765158032-376600608661-770344733697-116fe6bd7b3f779cc170a0c8f39ff344" https://slack.com/api/files.upload'''
          }
        }
